angular.module('mean.system')
  .controller('GameController', ['$scope', 'game', '$timeout', '$location', 'MakeAWishFactsService', '$http', '$window', ($scope, game, $timeout, $location, MakeAWishFactsService, $http, $window) => {
    ...
    $scope.switchColors = (index) => index % 2 === 0 ? { 'background-color': '#F98D3F', height: '220px' } : { 'background-color': '#256188', height: '220px' };
    ...
    $scope.saveGameLog = (gameInfo) => {
      ...
      const gamePlayers = gameInfo.players.map(players => players.username);
      const gameHistory = {
